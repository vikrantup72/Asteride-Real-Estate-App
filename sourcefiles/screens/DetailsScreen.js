...
import {handleNotification} from '../components/notification/notificationServices';
...
const DetailsScreen = ({navigation, route}) => {
  ...
  const onLock = () => {
    if (house.area == '30 Meter') {
      handleNotification(
        'Door is open',
        'Welcome back to your home',
        'Thank you for visiting our real estate',
        'purple',
      );
    } else {
      handleNotification(
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
        ...
        <View style={styles.backgroundImageContainer}>
          <ImageBackground style={styles.backgroundImage} source={house.image}>
            <View style={styles.header}>
              ...
              <View style={styles.headerBtn}>
                <Icon name="favorite" size={25} style={{color: COLORS.red}} />
              </View>
            </View>
          </ImageBackground>
          <TouchableOpacity
            ...
            <Text style={{color: COLORS.dark}}>Unlock the Door</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.footer}>
        <View
          ...
          <View>
            <Image
              source={require('../assets/img/owner.jpg')}
          ...
          <View>
            ...
            <Text style={{fontSize: 12, marginLeft: 10, textAlign: 'left'}}>
              Owner (Real Estate)
            </Text>
          </View>
        </View>
        <View
          ...
          <View style={styles.whatsappBtn}>
            <Pressable
              onPress={() =>
                Linking.openURL(
                  'https://api.whatsapp.com/send?phone=7080607057',
                )
              }>
              <Image
          ...
          {/* <Hyperlink
                        ...
                        linkText={(url) => url === 'https://api.whatsapp.com/send?phone=7080607057' ? 'Contact' : url}>
