...
} from '../components/notification/notificationServices';
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        handleNotification(
          'Login Successfully',
          'Welcome to our home',
          'Thank you for visiting to our real estate',
          'purple',
        );
        scheduleNotification();
        setModelOpen(false);
  ...
  const requestAlarmPermission = async () => {
    try {
      await PermissionsAndroid.request(
        ...
        {
          title: 'Notofication Permission',
          message: 'This app needs access to push notification.',
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#f5f5f5'}}>
      ...
      <View style={styles.container}>
        ...
        <Text style={{fontSize: 15, fontWeight: 'bold', color: '#ba55d3'}}>
          SIGN IN HERE
        </Text>

        <Card
          style={[styles.inputcard, {marginTop: 50, backgroundColor: 'white'}]}>
          <TextInput style={[styles.input]} placeholder="Enter Your Email" />
        </Card>

        <Card
          style={[styles.inputcard, {marginTop: 0, backgroundColor: 'white'}]}>
          <TextInput
            style={styles.input}
        ...
        <Modal transparent={true} visible={modelOpen} animationType="none">
          <View style={styles.modalView}>
            <LottieView
              style={{height: 80, width: 80}}
              source={require('../../sourcefiles/assets/img/loaderoverlay.json')}
              autoPlay
              loop
            />
