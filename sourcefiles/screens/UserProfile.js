    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <Surface style={styles.header}>
        ...
        <View style={{marginRight: 20}}>
          <Pressable>
            <Feather name="share-2" size={25} style={{color: '#15273F'}} />
          </Pressable>
        </View>
      </Surface>
      {/*  */}
      ...
      <View style={styles.profileInfo}>
        <View style={styles.imageContainer}>
          <Image
            source={{
              uri: 'https://avatars.githubusercontent.com/u/37727808?v=4',
            }}
      ...
      <Pressable onPress={() => navigation.navigate('Login')}>
        <View style={styles.action}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <Text style={[styles.actionTitle, {color: '#F25B68'}]}>Logout</Text>
          </View>
        </View>
      </Pressable>
      {/*  */}
      ...
      <View
        ...
        <Text style={{fontSize: 16, fontFamily: 'sans-serif-light'}}>
          Version: 0.0.1
        </Text>
      </View>
    </SafeAreaView>
